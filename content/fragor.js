  ...
  LESS.fragor = {
    ...
    psykolog: [
      { id: 'psy-ikbt-samma-vecka',
        ...
        motivering: 'iKBT med behandlarstöd finns i de flesta regioner via stöd- och behandlingsplattformen, så tekniken är sällan hindret. Flaskhalsen är en behandlare med ledig tid att följa modulerna vecka för vecka. Att starta samma vecka förutsätter alltså inte en plattform utan en person.',
        status: 'skattad av rådgivare' },
      ...
      { id: 'psy-tid-45min',
        ...
        berorFall: ['psy-anna', 'psy-katrin'],
        skattning: 35, sakerhet: 'medel',
        motivering: 'Ett psykologiskt nybesök är ofta bokat 45–60 minuter, så tiden finns på papperet. Fyra fullständiga moment i samma besök är däremot en bra dag, inte en vanlig. Det som oftast trängs undan är sömnen och underlaget, i den ordningen.',
        status: 'skattad av rådgivare' },

      { id: 'psy-boka-lakartid',
        fraga: 'Kan du som psykolog boka en läkartid åt din patient inom en vecka, eller måste patienten själv ringa?',
        bakgrund: 'Guldsvaret i psy-katrin bygger på att psykologen tar ägarskapet för den somatiska frågan och bokar tiden. Går det inte faller skillnaden mellan guld och silver i fallet.',
        berorFall: ['psy-katrin'],
        skattning: 25, sakerhet: 'låg',
        motivering: 'Att skriva en intern konsultationsfråga eller lägga en bokning till en kollega förekommer, men det vanliga är att psykologen skriver i journalen och ber patienten kontakta receptionen. Skillnaden är hela poängen i det här fallet: en fråga vars ägare är patienten själv har ingen ägare när patienten är för trött för att orka. Delfrågan som avgör: har du någon gång själv lagt en läkartid i kalendern åt en av dina patienter? Berör även läkarrådgivaren.',
        status: 'skattad av rådgivare' },

      { id: 'psy-somatisk-anamnes',
        fraga: 'Frågar du om vikt, mage, hud, hår och blödningar vid ett psykologiskt nybesök om trötthet?',
        bakgrund: 'I psy-katrin är det den enda fråga som skiljer fallen åt, och psykologen är sista ledet innan ett underlag skrivs. Se lak-somatisk-utredning-f43 och ssk-somatisk-fraga-triage.',
        berorFall: ['psy-katrin', 'psy-anna'],
        skattning: 20, sakerhet: 'medel',
        motivering: 'Frågan är tillåten, tar under en minut och kräver ingen medicinsk kompetens – det är en anamnesfråga, inte en undersökning. Ändå ligger den utanför det jag är van att göra: jag frågar om sömn, aptit och alkohol för de står i mallen, men inte om blödningar. Skälet är att jag i det gamla flödet visste att en läkare redan tagit den. I LESS har ingen gjort det. Jag skattar 20 för att någon av frågorna ställs och betydligt lägre för att de journalförs.',
        status: 'skattad av rådgivare' },

      { id: 'psy-avbryta-bokad-utredning',
        fraga: 'Har du avbrutit en bokad försäkringsmedicinsk utredning mitt i, för att en annan fråga behövde besvaras först?',
        bakgrund: 'Det centrala momentet i psy-katrin. Om det aldrig görs är fallets guldsvar ett ideal snarare än en praxis, och då behöver fallet lära ut hur man motiverar det – inte bara att man ska.',
        berorFall: ['psy-katrin'],
        skattning: 10, sakerhet: 'låg',
        motivering: 'Trycket åt andra hållet är starkt och kommer från alla håll samtidigt: tiden är bokad, patienten har tagit ledigt, remissen har en frågeställning och nästa besök är om tre veckor. Att skriva ett underlag med reservation känns som kompromissen, och det är den vanliga lösningen. Jag tror att den rena avbrytningen är sällsynt, och att det snarare beror på strukturen än på bedömningen. Delfrågan som avgör: när gjorde du det senast, och vad kostade det dig?',
        status: 'skattad av rådgivare' },

      { id: 'psy-reflektionstid-finns',
        fraga: 'Finns en återkommande tid där personalen pratar om egna reaktioner i sjukskrivningsärenden?',
        bakgrund: 'Hela mote-harbargering förutsätter att formen finns. Det bästa alternativet i slutvalet är dessutom att boka in den varannan vecka.',
        berorFall: ['mote-harbargering'],
        skattning: 15, sakerhet: 'medel',
        motivering: 'Handledning finns för psykologer och ibland för ST-läkare, men då i den egna professionen. Tvärprofessionell reflektion om egna känslor, återkommande och schemalagd, är något annat: den kostar sex personers tid samtidigt och producerar inga besök. APT finns, men där pratar man om scheman. Min gissning är att det förekommer som enstaka initiativ och nästan aldrig som rutin. Blir siffran låg är scenen ett förslag och inte en beskrivning – och då ska den spelas som ett förslag. Berör alla sex rådgivarna.',
        status: 'skattad av rådgivare' },

      { id: 'psy-ja-for-att-slippa',
        fraga: 'Hur ofta föreslår eller tillstyrker du en sjukskrivning du inte är övertygad om, för att samtalet ska ta slut?',
        bakgrund: 'Premissen för hela mötet. Är den ovanlig faller scenen.',
        berorFall: ['mote-harbargering', 'psy-anna'],
        skattning: 55, sakerhet: 'låg',
        motivering: 'Den här skattar man om sig själv, och det är därför siffran är osäker åt båda hållen: dels underrapportering, dels att man i efterhand hittar ett kliniskt skäl till det man gjorde av trötthet. Jag sätter den högt ändå. Mekanismen är negativ förstärkning och den kräver ingen slarvighet, bara en fredag. Det jag mest vill veta är om personalen känner igen sig eller blir förolämpad av frågan – blir de förolämpade är scenen fel skriven, inte de.',
        status: 'skattad av rådgivare' },

      { id: 'psy-nej-journalfors',
        fraga: 'Journalförs motiveringen, och vad patienten fick i stället, när du avråder från sjukskrivning?',
        bakgrund: 'Kedja 2 i mote-harbargering slutar i just den asymmetrin: ett ja lämnar ett intyg som går att granska, ett nej lämnar ofta ingenting.',
        berorFall: ['mote-harbargering'],
        skattning: 30, sakerhet: 'medel',
        motivering: 'Att något står i journalen efter besöket är förstås regel. Att ställningstagandet är formulerat som ett ställningstagande – varför inte, på vilket underlag, och vad som gjordes i stället – är ovanligare, och det är den varianten som gör beslutet möjligt att ompröva och att försvara. Det som oftast saknas är sista ledet: vad patienten faktiskt fick. Berör läkarrådgivaren minst lika mycket.',
        status: 'skattad av rådgivare' },

      { id: 'psy-saga-nejet-hogt-forst',
        fraga: 'Stämmer du av ett ställningstagande som skaver med en kollega innan du ger beskedet?',
        bakgrund: 'Ett av de tre hållbara alternativen i slutvalet i mote-harbargering.',
        berorFall: ['mote-harbargering'],
        skattning: 25, sakerhet: 'låg',
        motivering: 'Det görs, men oftast i korridoren och oftast när man redan bestämt sig – då är det inte en avstämning utan ett sökande efter medhåll. Den variant fallet föreslår är att formulera skälet högt för att höra om det håller, och att det gäller lika mycket för ett ja som skaver. Kostnaden är två minuter av en kollegas tid. Hindret är att man måste erkänna att man tvekar. Delfrågan som avgör: när gjorde du det senast med ett nej, inte med ett ja?',
        status: 'skattad av rådgivare' },

      { id: 'psy-skiftarbete-somnrad',
        fraga: 'Anpassar du sömnråden efter skiftschema, eller ger du standardrådet om fast uppstigningstid?',
        bakgrund: 'I psy-anna är fast uppstigningstid guldsvaret. I psy-katrin är samma råd omöjligt att följa och en av distraktorerna. Skillnaden är hela poängen med att sömnen får ett eget spår.',
        berorFall: ['psy-katrin', 'psy-anna'],
        skattning: 20, sakerhet: 'medel',
        motivering: 'Sömnhygien och KBT-i vid insomni är byggda kring ett dygn med sömn på natten, och materialet vi delar ut är skrivet för det. Skiftanpassade råd – ankartid, mörkläggning på dagen, planerad sömn före passet, koffeintiming – finns i litteraturen men sällan i mottagningens mappar. Min gissning är att den som möter en nattarbetare oftast antingen ger standardråden ändå eller hoppar över sömnen. Ett omöjligt råd kostar mer än inget råd: patienten lär sig att hon misslyckas med det vården ber henne göra.',
        status: 'skattad av rådgivare' }
    ],
    ...
    rehabkoordinator: [
      { id: 'rko-sitta-med-vid-samtal',
        ...
        berorFall: ['rko-anna'],
        skattning: 20, sakerhet: 'medel',
        motivering: 'Metoden är rätt och lärs ut, men den kräver att patienten sitter hos mig i just det fönster då chefen råkar svara. Det jag oftare gör är att förbereda samtalet – vad ska sägas, i vilken ordning, vad gör du om han säger nej – och att patienten ringer själv efteråt och berättar hur det gick. Skillnaden i agens mellan de två är liten; skillnaden i genomförbarhet är stor. Delfrågan som avgör: har du någon gång de senaste tre månaderna suttit bredvid en patient som ringde sin chef?',
        status: 'skattad av rådgivare' },

      { id: 'rko-avstamningsmote-tva-veckor',
        fraga: 'Går det att få till ett avstämningsmöte inom två veckor?',
        bakgrund: 'Bästa alternativet i rko-jonas förutsatte det, tills fallet skrevs om till trepartsmöte plus en begäran.',
        berorFall: ['rko-jonas'],
        skattning: 10, sakerhet: 'medel',
        motivering: 'Två invändningar. Den första är formell: avstämningsmöte kallar Försäkringskassan till, vården kan begära ett – tidsåtgången ligger alltså inte hos oss. Den andra är praktisk: tre kalendrar, en arbetsgivare som inte svarar på första försöket och en handläggare som kan ha bytts sedan förra kontakten. Två veckor är i min erfarenhet ovanligt snabbt. Det som däremot går på två veckor är ett trepartsmöte som vården själv kallar till.',
        status: 'skattad av rådgivare' },

      { id: 'rko-icke-sjukskrivna-patienter',
        fraga: 'Tar din rehabkoordinatorfunktion emot patienter som inte är sjukskrivna?',
        bakgrund: 'Hela mandatfrågan i rko-miriam. Lagen (2019:1297) gäller sjukskrivna patienter; flera regioner har ändå med "riskerar sjukskrivning" i uppdraget.',
        berorFall: ['rko-miriam', 'ssk-miriam'],
        skattning: 35, sakerhet: 'medel',
        motivering: 'Förarbetena är tydliga: regeringen valde att INTE göra förebyggande insatser till en skyldighet – men förbjöd dem inte. Region Kronoberg skriver rakt ut "sjukskrivna eller riskerar att bli sjukskrivna"; Region Östergötland låter varje vårdenhet avgöra. Så det förekommer, och i vissa regioner är det norm. Min skattning är ändå under hälften, av en enkel resursorsak: en koordinator på trettio procent med sextio pågående sjukfall prioriterar dem som redan har en sjukpenning att förlora. Berör även sjuksköterskerådgivaren – det är hennes triagebeslut som avgör om ärendet ens kommer hit.',
        status: 'skattad av rådgivare' },

      { id: 'rko-skriftligt-uppdrag',
        fraga: 'Finns det ett skriftligt uppdrag på din vårdcentral som säger vilka patienter du som koordinator tar emot?',
        bakgrund: 'Kontrollen MANDATET i rko-miriam bygger på att svaret går att slå upp. Utan skriftligt uppdrag är svaret vad chefen råkar tycka den dagen.',
        berorFall: ['rko-miriam'],
        skattning: 40, sakerhet: 'låg',
        motivering: 'Regional uppdragsbeskrivning finns nästan alltid. Frågan gäller den lokala: har DIN mottagning skrivit ned vilka patienter du tar, hur många ärenden du kan bära och vad du inte gör? Min gissning är att det ofta finns ett regiondokument som ingen läst och en lokal praxis som ingen skrivit ned – och att gränsen därför dras i stunden, av den som råkar boka. Är siffran låg är det ett fynd i sig: det förklarar varför samma patient tas emot på en vårdcentral och avvisas på nästa.',
        status: 'skattad av rådgivare' },

      { id: 'rko-arbetsplatskonflikt-utan-sjukdom',
        fraga: 'Hur ofta är grundproblemet i dina ärenden en arbetsplatskonflikt utan sjukdom?',
        bakgrund: 'rko-miriam förutsätter att det här är ett igenkännbart ärende, inte ett konstruerat.',
        berorFall: ['rko-miriam'],
        skattning: 55, sakerhet: 'medel',
        motivering: 'Skatta hur ofta konflikten är det som verkligen driver ärendet, inte hur ofta den nämns – nämnas gör den nästan jämt. Min erfarenhet är att en stor del av de stressrelaterade sjukfallen har en chef, en omorganisation eller en utfrysning i botten, och att sjukskrivningen ibland är det enda verktyg någon hittat. Blir siffran hög är det ett argument för fler fall av den här typen, inte färre.',
        status: 'skattad av rådgivare' },

      { id: 'rko-hanvisar-skyddsombud',
        fraga: 'Hänvisar du till skyddsombud eller fack när grundproblemet är arbetsmiljön?',
        bakgrund: 'Det gyllene avslutet i rko-miriam står och faller med att det här är en hänvisning koordinatorer faktiskt gör.',
        berorFall: ['rko-miriam'],
        skattning: 30, sakerhet: 'låg',
        motivering: 'Jag tror att vi hänvisar till företagshälsovård ofta och till skyddsombud sällan, trots att skyddsombudet är den enda part som kan tvinga fram ett skriftligt svar från arbetsgivaren och gå vidare till Arbetsmiljöverket om svaret uteblir. Skälet är förmodligen att vi kan FHV-vägen och inte den fackliga, och att det känns som att lägga sig i arbetsrätten. Det gör man inte – att säga att skyddsombudet finns är allmän information, inte partsställning. Låg säkerhet: det här är den fråga i listan där jag helst vill bli motbevisad.',
        status: 'skattad av rådgivare' },

      { id: 'rko-samtycke-avgransat',
        fraga: 'Är era samtycken avgränsade i vem, om vad och hur länge – eller generella?',
        bakgrund: 'Kontrollen om arbetsgivarkontakt i rko-miriam och samtyckesbeaten i rko-anna gör avgränsningen till facit.',
        berorFall: ['rko-miriam', 'rko-anna'],
        skattning: 25, sakerhet: 'medel',
        motivering: 'SKR har blanketter och Vårdhandboken säger att samtycket bör vara skriftligt och att muntligt ska dokumenteras med datum, sätt och innehåll. Att ett samtycke tas är alltså vanligt. Att det är avgränsat är något annat: min gissning är att den vanligaste varianten är ett kryss för "kontakt med berörda aktörer" taget vid första besöket, utan tidsgräns och utan angivet innehåll. Det håller tills någon ställer en fråga man inte tänkt på, och då står man ensam med den.',
        status: 'skattad av rådgivare' },

      { id: 'rko-journalplats-koordinering',
        fraga: 'Finns en självklar plats i journalsystemet för koordineringsinsatser – eget sökord, mall eller KVÅ-kod?',
        bakgrund: 'Alla tre rehabkoordinatorfallen slutar i att något ska dokumenteras. Saknas platsen blir dokumentationen osynlig för nästa person, och då är facit en instruktion utan mottagare.',
        berorFall: ['rko-anna', 'rko-jonas', 'rko-miriam'],
        skattning: 45, sakerhet: 'medel',
        motivering: 'Flera regioner har rutiner för diagnos- och KVÅ-registrering av koordineringskontakter, så strukturen finns på papperet. Frågan är om den finns i din journal, om du hittar den utan att leta, och om läkaren som skriver nästa intyg ser vad du skrivit. Regeringen bedömde i förarbetena att koordineringsinsatser inte är hälso- och sjukvård enligt HSL, samtidigt som patientdatalagen gjordes tillämplig – en gränsdragning som mycket väl kan vara en del av förklaringen till att anteckningen hamnar på en plats ingen annan tittar.',
        status: 'skattad av rådgivare' }
    ]
  };
