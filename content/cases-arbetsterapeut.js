       ...
       ================================================================ */
    {
      ...
      beats: [
        ...
        { typ: 'val',
          ...
          val: [
            { text: 'Ortos för tumbasen till arbetsmomenten, vertikalmus och pärmhållare, ändrad arbetsteknik, samt en genomgång av helgbelastningen tillsammans med Carina.',
              ...
              varfor: 'Du ändrar miljön och aktiviteten i stället för att ta bort arbetet. Att hon känner skillnaden i rummet är den starkaste tänkbara feedbacken – hon lämnar besöket med bevis, inte med löften.' },
        ...
        { typ: 'beslut',
          ...
          val: [
            { text: 'Ingen sjukskrivning. Ortos och hjälpmedel utprovade, arbetsplatsbedömning bokad, uppföljning om 4 veckor. Underlag till läkare för kännedom.',
              ...
              varfor: 'Aktiviteten och miljön ändrades, arbetsförmågan behölls. Det är precis den vinst LESS-flödet är byggt för: rätt kompetens direkt i stället för ett läkarbesök som bekräftar en känd diagnos.' },
      ...
      beats: [
        ...
        { typ: 'val',
          ...
          val: [
            ...
            { text: 'Det är förståeligt vid din ålder, vi kan titta på en längre sjukskrivning.',
              tid: 2, ok: false, princip: 'grad',
              humor: 'trott', reaktion: 'Gunilla nickar långsamt.',
              svar: 'Ja. Man har väl gjort sitt.',
              fx: { agens: -18, underlag: -10 },
              varfor: 'Ålder är inte en aktivitetsbegränsning, och en avvecklande sjukskrivning tre år före pension är svår att motivera försäkringsmedicinskt. Den kostar dessutom Gunilla en yrkesidentitet hon fortfarande har kvar.' },
        ...
        { typ: 'flera',
          ...
          val: [
            { text: 'Kartlägga vilka brukare som bor i trapphus utan hiss, och om ruttfördelningen kan ändras', ratt: true, princip: 'hjalpmedel',
              fx: { underlag: 12 },
              varfor: 'Miljöanpassning som är enkel att genomföra i en hemtjänstgrupp och som tar bort just det moment som fallerar.' },
        ...
        { typ: 'beslut',
          ...
          fraga: 'Vad går vidare?',
          val: [
            { text: 'Ingen sjukskrivning nu. Hjälpmedel och arbetsteknik insatta, skriftlig beskrivning av begränsningar till arbetsgivarsamtalet, rehabkoordinator kopplas in, uppföljning om 4 veckor.',
              ok: true, princip: 'hjalpmedel', tid: 2,
              fx: { agens: 12, underlag: 12 },
              utfall: 'Gunilla får en rutt utan trapphus och är kvar i arbete.',
              varfor: 'Aktiviteten anpassades, arbetsförmågan behölls och Gunilla behöll sitt yrke. Rehabkoordinatorn finns med om arbetsgivarsamtalet krånglar.' },
