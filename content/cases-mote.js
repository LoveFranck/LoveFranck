  ...
  LESS.fall.mote = [
       ...
       ================================================================ */
    {
      ...
      intro: [
        ...
        'Ove: den här kvarten handlar inte om patienterna. Den handlar om vad som händer i er när ni ska säga nej – och om vad som händer när ni säger ja för att slippa.',
      ...
      beats: [
        ...
        { typ: 'kedja',
          ...
          lank: [
            ...
            { etikett: 'K – LÅNG SIKT',
              ...
              val: [
                { text: 'Patienten får sin sjukskrivning tre dagar senare av en läkare utan underlag – och sjuksköterskan har lärt sig att svåra chattar löser sig om man ger med sig. Nästa gång kommer det snabbare.', ratt: true },
        ...
        { typ: 'val',
          ...
          val: [
            ...
            { text: 'Hållit fast vid nejet och avslutat ärendet.',
              ...
              varfor: 'Det tar bort ett ja som inte var motiverat och sätter ingenting i stället. Patienten söker igen, oftast senare och oftast sämre. Att stänga en dörr utan att öppna en annan är inte en bedömning – det är bara ett nej.' },
        ...
        { typ: 'kedja',
          ...
          lank: [
            ...
            { etikett: 'O – KROPPSLIG FÖRNIMMELSE',
              ...
              val: [
                ...
                { text: 'Lusten att avfärda utskriften.',
                  varfor: 'Beteendeimpulsen.' },
                { text: 'Fjortonde patienten den dagen, ingen lunch.',
                  varfor: 'Etablerande omständighet.' },
            ...
            { etikett: 'R – RESPONS',
              ...
              forklaring: 'Lägg märke till vad som saknas i responsen. Inte nejet – utan bedömningen. Ett nej kan vara helt riktigt i sak och ändå vara fattat på fel grund.' },
            ...
            { etikett: 'K – LÅNG SIKT',
              ...
              val: [
                ...
                { text: 'Utskriften ligger kvar på bordet.',
                  varfor: 'Situationen.' },
                { text: 'Hon hade fjorton patienter den dagen.',
                  varfor: 'Etablerande omständighet.' }
              ],
        ...
        { typ: 'kontroll',
          ...
          forklaring: 'Rätt. Ingenting av det ni gjort i dag säger något om vad utfallet ska bli i ett enskilt ärende. Analysen säger bara något om vad som styr när ni fattar det.' },

        { typ: 'replik', vem: 'lakare', humor: 'neutral',
          text: 'Jag vill säga det rakt ut, för det är mitt namn som står på besluten. Det finns ingen diagnosgrupp där svaret är givet på förhand. Varje ärende kräver en medicinsk och en försäkringsmedicinsk bedömning av just den patienten: funktion, aktivitetsbegränsning, faktiska arbetsuppgifter.' },

        { typ: 'replik', vem: 'lakare', humor: 'oppen',
          text: 'Och det finns gott om lägen där sjukskrivning är rätt vård, också vid F- och M-diagnoser. Vid uttalad utmattning med kognitiv påverkan kan ett uteblivet eller för litet ingripande vara det som gör skada. Det jag inte får göra är att låta min egen tisdagsförmiddag avgöra vilket det blir.' },
        ...
        { typ: 'replik', vem: 'rehabkoordinator', humor: 'neutral',
          text: 'Impulsen var att fixa det åt henne. Ett intyg hade gett henne fyra veckor och mig känslan av att ha gjort något. På fyra veckor hade jag gjort hennes arbetsmiljöproblem till en diagnos – och den enda som kan lösa det, arbetsgivaren, hade sluppit veta om det.' },
        ...
        { typ: 'val',
          ...
          val: [
            ...
            { text: 'Vi skriver in i mallen att motiveringen ska dokumenteras även när vi inte sjukskriver, tillsammans med det patienten fick i stället.',
              ...
              varfor: 'Det gör bedömningen granskningsbar också när den inte lämnar något intyg efter sig, och det tvingar fram raden om vad som gjordes i stället. Att journalföra ställningstagandet är dessutom ett krav på dokumentationen, inte en extra ambition – och det är det som gör beslutet möjligt att ompröva.',
